        ...
        <div className="grid gap-10 lg:grid-cols-[1.25fr_0.75fr]">
          ...
          <aside className="space-y-6">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
              <p className="text-xs uppercase tracking-[0.3em] text-slate-500 mb-4">Quick Summary</p>
              <ul className="space-y-3 text-sm text-slate-300">
                <li>We collect account, usage, and technical data to operate the service.</li>
                <li>We do not sell personal information.</li>
                <li>Live audio and transcripts are processed only to deliver features.</li>
                <li>You can request deletion of your account data.</li>
              </ul>
            </div>

            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
              <p className="text-xs uppercase tracking-[0.3em] text-slate-500 mb-4">Contact</p>
              <p className="text-sm text-slate-300">support@parleap.com</p>
            </div>
          </aside>
        </div>
      </div>
