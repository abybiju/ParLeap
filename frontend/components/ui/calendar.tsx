    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-white/10 hover:bg-white/10 text-white"
        ),
        ...
        day_selected:
          "bg-gradient-to-r from-orange-500 to-red-600 text-white hover:bg-gradient-to-r hover:from-orange-500 hover:to-red-600 hover:text-white focus:bg-gradient-to-r focus:from-orange-500 focus:to-red-600 focus:text-white",
